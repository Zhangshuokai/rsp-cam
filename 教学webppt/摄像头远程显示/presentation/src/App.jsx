        ...
        >
          <div className="flex items-center gap-2.5 px-5 py-5">
            <div className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br from-brand-600 to-teal2 text-white">
              <span className="text-[0.95rem] font-extrabold">像</span>
            </div>
            <div className="leading-tight">
              <p className="text-[0.9rem] font-bold text-ink">摄像头远程显示</p>
              <p className="text-[0.72rem] text-muted">教学demo · TCP 推流</p>
            </div>
            <button
              onClick={() => setSidebar(false)}
              title="收起目录 ["
